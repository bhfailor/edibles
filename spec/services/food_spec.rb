...
describe Food do
  ...
  context 'valid food number' do
    let(:valid_code) {'11356'} # baked russet potatoes, flesh and skin
    let(:food) { Food.new(code: valid_code) }
...
show actions -- :new will allow the input of the food code and will act as the
